...
public class InstructionFormModels {
    ...
    final static String setSoundToLabels[] = {"TEMPO", "NOTE_DURATION", "OCTAVE", "VOLUME", "INSTRUMENT", "MIDI_NOTE", "ATTACK", "DECAY"};
    final static String setSoundByLabels[] = {"TEMPO", "NOTE_DURATION", "OCTAVE", "VOLUME"};
